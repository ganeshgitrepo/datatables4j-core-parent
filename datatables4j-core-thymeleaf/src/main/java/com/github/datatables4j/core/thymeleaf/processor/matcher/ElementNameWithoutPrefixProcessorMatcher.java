package com.github.datatables4j.core.thymeleaf.processor.matcher;
...
public class ElementNameWithoutPrefixProcessorMatcher implements IElementNameProcessorMatcher {
    ...
    public ElementNameWithoutPrefixProcessorMatcher(final String elementName, final Map<String,String> attributeValuesByNameFilter) {
        super();
